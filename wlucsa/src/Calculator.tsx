    ...
    <div className="mt-10 relative bg-[#61918e] p-8 md:p-12 min-h-[100px] flex flex-col overflow-hidden transition-all duration-300 shadow-xl border-4 border-[#ccdbdb]/60 rounded-xl ">
      ...
      >
        <div className="text-center md:text-left z-20">
          {isOpen && (
            <p className="font-medium text-white/80 uppercase tracking-widest text-[10px] md:text-xs mb-1 animate-fadeIn">
              Total Combined Savings
            </p>
          )}
          <h1 className="text-2xl md:text-5xl max-w-[100%] md:max-w-[60%] font-black text-white uppercase transition-all duration-300">
            {isOpen 
